...
const StockList = () => {
  ...
  if (state.isLoading) {
    return (
      <div className="container flex w-full h-[70vh] items-center justify-center">
        <CircularProgress />
      </div>
    );
  }
  ...
  return (
    <>
      {state.isError ? (
        <div className="container flex flex-col w-full h-[70vh] items-center justify-center">
          {state.errMsg}
          <button
            className="border my-3 px-5 p-1 rounded-lg"
            onClick={() => {
